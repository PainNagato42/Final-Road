class Cars {
    constructor() {
        ...
        police.src = "http://localhost/jeux/final_road/img/police.png";
        police.onload = () => {
            this.image = police;
            this.widthPolice = 37;
        ...
        chasseur.src = "http://localhost/jeux/final_road/img/chasseur.png";
        chasseur.onload = () => {
        ...
        alien.src = "http://localhost/jeux/final_road/img/vaisseau_2.png";
        alien.onload = () => {
            this.image3 = alien;
            this.widthAlien = 60;
            this.heightAlien = 47;
