class Player {
    constructor() {
        ...
        blueCar.src = "http://localhost/jeux/final_road/img/voiture_bleue.png";
        blueCar.onload = () => {
            this.image = blueCar;
            this.widthBlue = 44;
            this.heightBlue = 77;
        ...
        blackCar.src = "http://localhost/jeux/final_road/img/voiture_noire.png";
        blackCar.onload = () => {
        ...
        redCar.src = "http://localhost/jeux/final_road/img/voiture_rouge.png";
        redCar.onload = () => {
            this.image3 = redCar;
            this.widthRed = 44;
            this.heightRed = 76;
        ...
        pinkCar.src = "http://localhost/jeux/final_road/img/voiture_rose.png";
        pinkCar.onload = () => {
            this.image4 = pinkCar;
            this.widthPink = 49;
            this.heightPink = 77;
        ...
        greenCar.src = "http://localhost/jeux/final_road/img/voiture_verte.png";
        greenCar.onload = () => {
        ...
        const f1 = new Image();
        f1.src = "http://localhost/jeux/final_road/img/f1.png";
        f1.onload = () => {
            this.image6 = f1;
            this.widthF1 = 35;
            this.heightF1 = 80;
        ...
        purpleBike.src = "http://localhost/jeux/final_road/img/moto_violette.png";
        purpleBike.onload = () => {
        ...
        yellowBike.src = "http://localhost/jeux/final_road/img/moto_jaune.png";
        yellowBike.onload = () => {
        ...
        greenBike.src = "http://localhost/jeux/final_road/img/moto_verte.png";
        greenBike.onload = () => {
        ...
        redBike.src = "http://localhost/jeux/final_road/img/moto_rouge.png";
        redBike.onload = () => {
        ...
        blueBike.src = "http://localhost/jeux/final_road/img/moto_bleue.png";
        blueBike.onload = () => {
        ...
        blackBike.src = "http://localhost/jeux/final_road/img/moto_noire.png";
        blackBike.onload = () => {
        ...
        truck.src = "http://localhost/jeux/final_road/img/camion.png";
        truck.onload = () => {
            this.image13 = truck;
            this.widthTruck = 40;
            this.heightTruck = 99;
        ...
        const jet = new Image();
        jet.src = "http://localhost/jeux/final_road/img/avion.png";
        jet.onload = () => {
            this.image14 = jet;
            this.widthJet = 70;
            this.heightJet = 70;
        ...
        spaceship.src = "http://localhost/jeux/final_road/img/vaisseau.png";
        spaceship.onload = () => {
